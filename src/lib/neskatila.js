...
//En el contexto de la programacion orientada a objetos, "class" se utiliza para definir una plantilla para la creacion de objetos. 
...
// Esto significa que no necesitamos crear una instancia nueva con "new" para crear un objeto "Neskatila" antes de poder usar estos metodos.
// El metodo "init" se utiliza para establecer la configuracion de "Neskatila", incluyendo "serverURL" que determina a que servidor backend se conectara. 
