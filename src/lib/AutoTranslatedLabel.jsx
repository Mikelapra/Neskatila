...
export const AutoTranslatedLabel = (props) => {
    ...
    // Cuando se monta el componente, se llama a la funcion "translate" para traducir el valor proporcionado en las propiedades del componente. 
    ...
    return (
        <span className={css ? css : ''}>{labelValue}</span> // css opcional.
    )
}
